			...
			<div class="tg-container">
			   <div class="logo-wrapper clearfix">
				 <?php if( ( get_theme_mod( 'estore_logo_placement', 'header_text_only' ) == 'show_both' || get_theme_mod( 'estore_logo_placement', 'header_text_only' ) == 'header_logo_only' ) ) {
				 	...
				 	?>
					<div class="logo">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img width="300" src="<?php echo esc_url(get_theme_mod('estore_logo' )); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" /></a>
					</div> <!-- logo end -->
					<?php }
...
<!--							--><?php //get_search_form(); ?>
                            <form role="search" method="get" class="woocommerce-product-search" action="http://annhien.me/">
                                <label class="screen-reader-text" for="woocommerce-product-search-field">Search for:</label>
                                <input style="margin-bottom: 0; width: 72%;" type="search" id="woocommerce-product-search-field" class="search-field" placeholder="Nhập Số…" value="" name="s" title="Search for:">
                                <input style="margin-bottom: 0" type="submit" value="Tìm Số">
