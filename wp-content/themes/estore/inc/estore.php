...
function estore_breadcrumbs(){
  /* === OPTIONS === */
	$text['home']     = esc_html__('Trang Chủ', 'estore'); // text for the 'Home' link
	$text['category'] = esc_html__('%s', 'estore'); // text for a category page
	$text['tax'] 	  = esc_html__('%s', 'estore'); // text for a taxonomy page
	$text['search']   = esc_html__('Kết quả tìm kiếm cho từ khóa "%s"', 'estore'); // text for a search results page
	$text['tag']      = esc_html__('%s', 'estore'); // text for a tag page
	$text['author']   = esc_html__('%s', 'estore'); // text for an author page
